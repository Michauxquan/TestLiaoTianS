    ...
    public class CommonBusiness
    {
        ...
        public static string KFUrl
        {
            get
            {
                if (_kfurl == null)
                {
                    _kfurl = CommonBusiness.Select("SysSetting", "top 1 KFUrl", " 1=1 ").ToString();
                }
                return _kfurl;
            }
            set
        ...
        public static List<AppSetting> GetAppSet()
        {

            List<AppSetting> lList = new List<AppSetting>();
            DataTable dt = new CommonDAL().GetAppSetList();
            foreach (DataRow dr in dt.Rows)
            {
